...
function doCSV(trips,fills,services,costs,claims,vehicle,taxYear,sarsDed,claimable,totKm,totB){
  ...
  c+="VEHICLE\n"+["Type","Make","Model","Year","Reg","Engine No","Lic Expiry","RWC Expiry"].map(q).join(",")+"\n";
...
export default function App(){
  ...
  if(rwcExp&&daysUntil(vehicle.rwcExpiry)<=60)            alerts.push({...rwcExp,label:"Roadworthy (RWC)"});
          ...
          <div>
            ...
            <Card>
              {!vEdit?(<div>
                ...
                <InfoRow label="Roadworthy (RWC)" value={vehicle.rwcExpiry}><ExpiryChip dateStr={vehicle.rwcExpiry}/></InfoRow>
                ...
                <div style={G2}>
                  ...
                  <div><label style={LBL}>Roadworthy (RWC) Expiry</label><input type="date" style={INP} value={vDraft.rwcExpiry||""} onChange={e=>setVDraft({...vDraft,rwcExpiry:e.target.value})}/></div>
